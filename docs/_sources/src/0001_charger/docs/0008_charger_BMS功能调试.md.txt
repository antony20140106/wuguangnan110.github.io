...
底层收到关闭的ioctrl，log如下：
```log
11-02 10:08:35.350 I/xxx_BMS (    0): SET_CHG_EN: 0
11-02 10:08:35.350 E/        (    0): bms_notify_call_chain
11-02 10:08:35.350 E/xxx_CHG (    0): bms_notify_event evt = SET_CHG_EN en:0
11-02 10:08:35.352 E/xxx_CHG (    0): enable_charging en: 0 last_en: 1
11-02 10:08:35.352 E/xxx_CHG (    0): xxx_charger_update, delay<40>
11-02 10:08:35.352 I/xxx_BMS (    0): type: NC_DISABLE_CHG_BY_USER, disable: 1, vote: 0x200000
11-02 10:08:35.352 I/xxx_BMS (    0): SET_POWER_PATH: 0
11-02 10:08:35.352 E/        (    0): bms_notify_call_chain
11-02 10:08:35.352 E/xxx_CHG (    0): bms_notify_event evt = SET_POWER_PATH en:0
11-02 10:08:35.353 E/xxx_CHG (    0): enable_powerpath en: 0
11-02 10:08:35.353 E/xxx_CHG (    0): xxx_charger_update, delay<40>
```
...
```java
   public BatteryTermInfo(Context context,int curmode){
		...
		}else if(model.equals("M5x")){
			this.predicted_hours = PREDICTED_HOURS_DEFAULT_M5x;	
		}else if(model.equals("A665x")){
			this.predicted_hours = PREDICTED_HOURS_DEFAULT_A665x;	
		}else if(model.equals("M92xx")){
			this.predicted_hours = PREDICTED_HOURS_DEFAULT_M92xx;	
		}else{
			this.predicted_hours = PREDICTED_HOURS_DEFAULT;
		}
        //if(model.equals("M5x") || model.equals("A800") || model.equals("M8")){//M5x,3, , 5
...
11-03 04:10:34.232 E/xxx_CHG (    0): vbus_off
11-03 04:10:34.232 E/xxx_CHG (    0): issue work, ops<0>, delay<0>
11-03 04:10:34.232 E/xxx_CHG (    0): _set_otg_enable now_status:0 set_status:0
...
11-03 04:10:34.392 E/xxx_CHG (    0): handle_typec_attach_dettach: ++ en:1
...
11-03 04:10:34.655 E/xxx_CHG (    0): set charge_type: DCP //2. qcom完成bc1.2检测
11-03 04:10:34.656 E/xxx_CHG (    0): xxx_is_charger_on chr_type = [DCP] last_chr_type = [Unknown]
11-03 04:10:34.656 E/xxx_CHG (    0): xxx_charger_plug_in
11-03 04:10:34.656 E/xxx_CHG (    0): enable_charging en: 1 last_en: 0 //3. 使能充电
11-03 04:10:34.657 E/xxx_CHG (    0): xxx_charger_update, delay<40> 4. 上报信息
11-03 04:10:34.657 E/xxx_CHG (    0): [SW_JEITA] Battery Normal Temperature between 15 and 45 !!
11-03 04:10:34.657 E/xxx_CHG (    0): [SW_JEITA]preState:3 newState:3 tmp:30 cv:0
11-03 04:10:34.657 E/xxx_CHG (    0): tmp:30 (jeita:1 sm:3 cv:0 en:1) thm_sm:1 en:1 can_en:1
11-03 04:10:34.658 E/xxx_CHG (    0): is typec adapter rp = 3000
11-03 04:10:34.658 E/xxx_CHG (    0): type-C pd_type:0 typec_rp_level:3000
11-03 04:10:34.658 E/xxx_CHG (    0): chg:-1,-1,2000,4140 type:5:0 aicl:-1 bootmode:0 pd:0
11-03 04:10:34.658 E/xxx_CHG (    0): do_algorithm input_current_limit:2000 charging_current_limit:4140
11-03 04:10:34.662 E/xxx_CHG (    0): CHG [online: 0, type: DCP, status: Not charging, fault: 0x0, ICHG = 4080mA, AICR = 2000mA, MIVR = 4360mV, IEOC = 240mA, CV = 4375mV]
...
11-03 04:10:34.741 E/xxx_BAT (    0): [status:Discharging, health:Good, present:1, tech:Li-ion, capcity:80,cap_rm:3578 mah, vol:4038 mv, temp:30, curr:-421 ma, ui_soc:80]
11-03 04:10:34.741 E/xxx_BAT (    0): xxx_battery_external_power_changed event, online:0, status:3, cur_chr_type:5 //5. Battery收到回调，此时online = 0 非充电状态
11-03 04:10:34.741 E/xxx_BMS (    0): bms_wakeup
...
11-03 04:10:34.751 E/xxx_BMS (    0): xxx_bms_external_power_changed online = 0
11-03 04:10:34.751 E/xxx_BMS (    0): CHG [online: 0, type: 5, vol: 5000000, cur: 500000, time: 0], BAT [present: 1, status: 3, vol: 4038000, cur: -421000, resistance: 0, temp: 300, soc: 80], OTHER [skin_temp: 0, chg_vote: 0x0, notify_code: 0x0],
...
11-03 04:10:34.814 E/xxx_CHG (    0): pd_status:1 // 6. 接下来PD设置快充电压电流，先设置了9v充电电压
11-03 04:10:34.814 E/xxx_CHG (    0): set pd_charging_voltage_max:9000 mv
11-03 04:10:34.814 E/xxx_CHG (    0): set pd_charging_current_max:277 ma
...
11-03 04:10:34.974 E/xxx_CHG (    0): set pd_charging_voltage_max:9000 mv
11-03 04:10:34.974 E/xxx_CHG (    0): set pd_charging_current_max:2000 ma
...
11-03 04:10:35.299 E/xxx_CHG (    0): pd_status:1
11-03 04:10:35.299 E/xxx_CHG (    0): set pd_charging_current_max:2000 ma
...
11-03 04:10:36.123 E/xxx_BAT (    0): [status:Discharging, health:Good, present:1, tech:Li-ion, capcity:80,cap_rm:3578 mah, vol:4254 mv, temp:30, curr:2537 ma, ui_soc:80]
...
11-03 04:10:39.657 E/xxx_CHG (    0): xxx_is_charger_on chr_type = [DCP] last_chr_type = [DCP]
11-03 04:10:39.659 E/xxx_CHG (    0): [SW_JEITA] Battery Normal Temperature between 15 and 45 !!
11-03 04:10:39.659 E/xxx_CHG (    0): [SW_JEITA]preState:3 newState:3 tmp:30 cv:0
11-03 04:10:39.659 E/xxx_CHG (    0): tmp:30 (jeita:1 sm:3 cv:0 en:1) thm_sm:1 en:1 can_en:1
11-03 04:10:39.660 E/xxx_CHG (    0): chg:-1,-1,2000,4160 type:5:6 aicl:-1 bootmode:0 pd:1
11-03 04:10:39.660 E/xxx_CHG (    0): do_algorithm input_current_limit:2000 charging_current_limit:4160
11-03 04:10:39.665 E/xxx_CHG (    0): CHG [online: 1, type: DCP, status: Charging, fault: 0x0, ICHG = 4160mA, AICR = 2000mA, MIVR = 4360mV, IEOC = 240mA, CV = 4375mV]
11-03 04:10:39.958 E/xxx_BMS (    0): CHG [online: 1, type: 5, vol: 5000000, cur: 2000000, time: 0], BAT [present: 1, status: 3, vol: 4254000, cur: 2537000, resistance: 0, temp: 300, soc: 80], OTHER [skin_temp: 0, chg_vote: 0x0, notify_code: 0x0],
```
...
-               //xxx_charger_dev_enable_vbus_ovp(g_info->chg1_dev, false);
...
@@ -1087,8 +1079,9 @@ static int xxx_charger_plug_in(struct xxx_charger *info,
...
11-02 10:09:15.501 E/xxx_CHG (    0): xxx_charger_update, delay<20> //1.重新上报状态
11-02 10:09:15.502 E/xxx_CHG (    0): pd_status:1
11-02 10:09:15.502 E/xxx_CHG (    0): set pd_charging_current_max:2000 ma
...
11-02 10:09:15.566 E/xxx_BAT (    0): [status:Charging, health:Good, present:1, tech:Li-ion, capcity:81,cap_rm:3626 mah, vol:4050 mv, temp:32, curr:-442 ma, ui_soc:81]
11-02 10:09:15.566 E/xxx_BAT (    0): xxx_battery_external_power_changed event, online:1, status:1, cur_chr_type:5 //2. Battery 状态获取正确
11-02 10:09:15.566 E/xxx_BMS (    0): bms_wakeup
11-02 10:09:15.574 E/xxx_BMS (    0): xxx_bms_external_power_changed online = 1
11-02 10:09:15.576 I/xxx_BMS (    0): charge start: 147
11-02 10:09:15.576 E/xxx_BMS (    0): CHG [online: 1, type: 5, vol: 5000000, cur: 2000000, time: 0], BAT [present: 1, status: 1, vol: 4050000, cur: -442000, resistance: 0, temp: 320, soc: 81], OTHER [skin_temp: 0, chg_vote: 0x0, notify_code: 0x0],
...
11-02 10:09:15.740 I/xxx_BMS (    0): SET_CHG_EN: 0 // 3. BMS服务发现此时电量大于满充点，则关闭充电。
11-02 10:09:15.740 E/        (    0): bms_notify_call_chain
11-02 10:09:15.740 E/xxx_CHG (    0): bms_notify_event evt = SET_CHG_EN en:0
11-02 10:09:15.741 E/xxx_CHG (    0): enable_charging en: 0 last_en: 1
11-02 10:09:15.741 E/xxx_CHG (    0): xxx_charger_update, delay<40>
11-02 10:09:15.741 I/xxx_BMS (    0): type: NC_DISABLE_CHG_BY_USER, disable: 1, vote: 0x200000
11-02 10:09:15.750 I/xxx_BMS (    0): SET_CHG_EN: 0
11-02 10:09:15.750 E/        (    0): bms_notify_call_chain
11-02 10:09:15.750 E/xxx_CHG (    0): bms_notify_event evt = SET_CHG_EN en:0
11-02 10:09:15.752 E/xxx_CHG (    0): enable_charging en: 0 last_en: 0
11-02 10:09:15.752 E/xxx_CHG (    0): xxx_charger_update, delay<40>
11-02 10:09:15.752 I/xxx_BMS (    0): type: NC_DISABLE_CHG_BY_USER, disable: 1, vote: 0x200000
...
11-02 10:09:15.812 E/xxx_BAT (    0): [status:Not charging, health:Good, present:1, tech:Li-ion, capcity:81,cap_rm:3626 mah, vol:4050 mv, temp:32, curr:-442 ma, ui_soc:81]
11-02 10:09:15.812 E/xxx_BAT (    0): xxx_battery_external_power_changed event, online:1, status:3, cur_chr_type:5
11-02 10:09:15.812 E/xxx_BMS (    0): bms_wakeup
11-02 10:09:15.816 E/xxx_BMS (    0): xxx_bms_external_power_changed online = 1
11-02 10:09:15.818 I/xxx_BMS (    0): charge end: charge_start_time: 147, charge_total_time: 0
```
...
```diff
--- a/QSSI.12/frameworks/base/services/core/java/com/xxx/server/PaxBatteryManagerService.java
+++ b/QSSI.12/frameworks/base/services/core/java/com/xxx/server/PaxBatteryManagerService.java
...
```log
Charging:
01-31 15:32:00.928 E/xxx_BAT (    0): [status:Charging, health:Good, present:1, tech:Li-ion, capcity:100,cap_rm:5108 mah, vol:4339 mv, temp:28, curr:251 ma, ui_soc:100]
...
Full:
01-31 15:32:50.078 E/xxx_BAT (    0): [status:Full, health:Good, present:1, tech:Li-ion, capcity:100,cap_rm:5108 mah, vol:4318 mv, temp:28, curr:-3 ma, ui_soc:100]
01-31 15:32:50.086 W/healthd (    0): battery l=100 v=4318 t=28.0 h=2 st=5 c=-3000 fc=5108000 cc=6 chg=u
01-31 15:32:50.107 I/xxx_BMS (    0): SET_CHG_EN: 0
01-31 15:32:50.107 E/        (    0): bms_notify_call_chain
01-31 15:32:50.107 E/xxx_CHG (    0): bms_notify_event evt = SET_CHG_EN en:0
