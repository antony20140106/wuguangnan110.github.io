...
NO.|文件名称|摘要
:--:|:--|:--
0013| [TCPM对外接口介绍](docs/0013_TCPM对外接口介绍.md) | typec对外接口介绍
0012| [T3400给低电M8供电无法开机](docs/0012_T3400给低电M8供电无法开机.md) | 分析平板在没有电的时候，通过T3400给平板充电，无法开机问题
0011| [开机插入U盘不识别问题分析](docs/0011_开机插入U盘不识别问题分析.md) | 目前发现开机插入U盘不识别问题分析，MTK平台没问题。
0010| [qcom_qcm2290_煲机压力测试USB失效问题分析](docs/0010_qcom_qcm2290_煲机压力测试USB失效问题分析.md) | 发现机器葆机后，USB无法使用，不枚举，充电状态不更新。
...
0005| [qcm2290_USB_Type-C_PD_Controller_HUSB311调试记录](docs/0005_qcm2290_USB_Type-C_PD_Controller_HUSB311调试记录.md) | TypeC_高通A665x_USB_Type-C_PD_Controller_HUSB311调试记录。
